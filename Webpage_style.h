...
<html>
<head>
<title>Farming Monitoring robot</title>
</head>
<style>
...
<div class="widget"> 
  ...
  <div style="text-align: center;"><a href="https://NSUT.com" style="align:center">NSUT.com</a></div>
  <div class="lower">    
    <ul class="infos">
      <li class="info temp">
      ...
      <li class="info wind">
        ...
        <span class='update' id="moisture_percentage">0%</span>
      </li>
      <li class="info humidity">
        <h2 class="title">HUMIDITY</h2>
        <span class='update' id="humidity">23%</span>
      </li>
      <li class="info WaterLevel">
        <h2 class="title">Water Level</h2>
        <span class='update' id="WaterLevel">23%</span>
      </li>
    </ul>
  </div>
</div>
